      ...
      <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0 w-full">
        ...
        <div className="content-stretch flex gap-0.5 items-center justify-start relative shrink-0">
          <button className="overflow-clip relative shrink-0 size-[26px]">
            <Image src={comment.isHeartSelected ? "/icons/heart_selected.svg" : "/icons/heart.svg"} alt="heart" width={14} height={12} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
          </button>
          <button className="overflow-clip relative shrink-0 size-[26px]">
            <Image src="/icons/message.svg" alt="comment" width={12} height={12} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
          </button>
          <button className="overflow-clip relative shrink-0 size-[26px]">
            <Image src="/icons/alarm.svg" alt="report" width={12} height={15} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
          </button>
        </div>
      </div>
